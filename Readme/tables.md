...
| `completed_late` | BOOLEAN NOT NULL DEFAULT false | **Legacy:** колонка остаётся в БД после миграции; приложение с версии **277** не читает и не пишет это поле (нет отдельного статуса «с опозданием» в UI и отчётах). |
