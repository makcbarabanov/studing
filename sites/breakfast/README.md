...
**Tone of Voice:** Светлана всегда говорит о себе в **женском роде** (рада, подумала, представила) — см. [`prompts/sveta.md`](prompts/sveta.md) и `_SVETA_FEMALE_RULE` в `breakfast_sveta.py`.
